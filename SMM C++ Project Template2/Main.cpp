...
#include <ctime>
using namespace std;
//Заполнение массива случайными числами из диапазона от 
//begin до end
template <typename T>
...
*/
	...
	*pn = 15; // меняем значение n с помощью разыменования
	cout << "Новая n = " << n << '\n';
	...
	pa2 = arr;//направляем указетель pa2  на адрес первого элемента
	cout << "*pa2 = " << *pa2 << '\n';//10
